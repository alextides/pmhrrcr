...
<head>
  ...
  <title> Subscription | Training Materials </title>
  <link rel="stylesheet" href="<?= base_url(); ?>payment-assets/css/bootstrap.min.css">
  <link rel="stylesheet" href="<?= base_url(); ?>payment-assets/css/fa-solid.min.css">
  <link rel="stylesheet" href="<?= base_url(); ?>payment-assets/css/fontawesome.min.css">
  <?php if ($gateways['authorize'] || $gateways['payeezy']) : ?>
    <link rel="stylesheet" href="<?= base_url(); ?>payment-assets/css/card.css">
  <?php endif; ?>
  <link rel="stylesheet" href="<?= base_url(); ?>payment-assets/css/square.css">
  <link rel="stylesheet" href="<?= base_url(); ?>payment-assets/css/style.css">
  <!-- page css -->
...
<body>
  <div>
    ...
    <section id="wrapper">
      <div class="login-register" style="position:relative;">
        <div class="register-box card" style="height: auto; width: 100%; max-width: 917px;">
          <div class="register-card-body">
            <div class="logo-main">
              <img class="main-logo" src="<?= base_url("assets/images/main-logo.png") ?>" alt="Main Logo">
              <div class="napacusa_name">
                <label>Subscription for Training Materials</label>
              </div>
            </div>
            <form id="paymentform" class="" action="" method="post">
              <input type="hidden" name="Fk_User_Id" id="Fk_User_Id" value="<?= $this->session->userdata('user_details')[0]['user_id']; ?>">
              <input type="hidden" name="Fk_Training_Id" id="Fk_Training_Id" value="<?= $subs[0]['training_id']; ?>">
                    ...
                    <div class="form-row">
                      <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                          ...
                          <input type="number" step="0.01" min="0.01" name="Amount" value="<?= $subs[0]['subscription_price']; ?>" class="form-control form-control-lg required" id="Amount" placeholder="0.00" aria-describedby="AmountPrepend">
                          <input type="hidden" step="0.01" min="0.01" name="Subs_Price" value="<?= $subs[0]['subscription_price']; ?>" class="form-control form-control-lg required" id="Subs_Price" placeholder="0.00" aria-describedby="AmountPrepend">
                      ...
                      <?php if (!DONATION) : ?>
                        <div class="col-md-6 mb-3">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" name="Payment_For" value="<?= $subs[0]['book_name']; ?>" class="form-control form-control-lg required" id="Payment_For" placeholder="Enter payment details" aria-describedby="Payment_ForPrepend">
                            <div class="invalid-tooltip">
                  ...
                  <div class="form-row">
                    <div class="col-md-12 mb-3">
                      ...
                      <div class="input-group">
                        ...
                        <input type="hidden" name="First_Name" class="form-control form-control-lg required" id="First_Name" value="<?= $this->session->userdata('user_details')[0]['first_name']; ?>">
                        <input type="hidden" name="Last_Name" class="form-control form-control-lg required" id="Last_Name" value="<?= $this->session->userdata('user_details')[0]['last_name']; ?>">
                        <div class="invalid-tooltip">
                  ...
                  <div class="form-row">
                    <div class="col-md-12 mb-3">
                      ...
                      <div class="input-group">
                        ...
                        <input type="hidden" name="Email" class="form-control form-control-lg required" id="Email" value="<?= $this->session->userdata('user_details')[0]['email']; ?>">
                        <div class="invalid-tooltip">
                    ...
                    <div class="col-md-4 col-sm-6">
                      <div class="form-group">
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control form-control-lg text-right amount" value="$<?= $subs[0]['subscription_price']; ?>.00" style="font-weight:bold;" disabled>
  ...
  <?php endif; ?>
  <script src="<?= base_url(); ?>payment-assets/js/jquery-3.3.1.min.js"></script>
  <?php if ($gateways['authorize'] || $gateways['payeezy']) : ?>
    <script src="<?= base_url(); ?>payment-assets/js/jquery.card.js"></script>
  <?php endif; ?>
  <script src="<?= base_url(); ?>payment-assets/js/popper.min.js"></script>
  <script src="<?= base_url(); ?>payment-assets/js/bootstrap.min.js"></script>
  <?php if ($gateways['stripe']) : ?>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      function showsuccess(trans) {
        $('#coverpage').html('<div class="successpage col-md-12 text-center"><div class="mt-4"><i class="fas fa-check-circle fa-9x text-success" ></i><h2>Your transaction with the amount of $' + <?= $subs[0]['subscription_price']; ?> + ' was completed successfully</h2><?php if (!TEST_EMAIL) : ?><h3 class="mb-5">Transaction ID: <b>' + trans + '</b></h3><?php endif; ?><p><a href="<?= base_url('training_materials'); ?>" class="btn btn-primary btn-lg">Go Back</a></p></div></div>');
        $('#coverpage').fadeIn();
      }
      ...
      function getajax() {
        ...
        $.ajax({
          type: "POST",
          url: "<?= base_url('payment/ajax_payment'); ?>",
          data: formdata,
      ...
      <?php if ($gateways['paypal']) : ?>
        paypal.Button.render({
          ...
          payment: function(data, actions) {
            ...
            var CREATE_URL = "<?php echo base_url('payment/ajax_payment/direct'); ?>";
          ...
          onAuthorize: function(data, actions) {
            ...
            var EXECUTE_URL = "<?= base_url('payment/ajax_payment/return'); ?>";
